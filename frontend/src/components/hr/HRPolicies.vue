  ...
  <div class="policies-content">
    <div class="row g-4">
        ...
        <div class="card h-100 border-0 shadow-sm rounded-3">
          <div class="card-body p-0">
            <div class="ratio ratio-4x3">
              <iframe src="/docs/Human Resources Policy.pdf" frameborder="0" class="w-100 h-100 rounded-top"></iframe>
            </div>
          </div>
          <div class="card-footer text-muted small bg-white rounded-bottom">Company Policies</div>
        </div>
      </div>
      ...
      <div class="col-12 col-md-6 d-flex flex-column">
        ...
        <div class="chat-card card flex-grow-1 d-flex flex-column border-0 shadow-sm rounded-3">
          <div class="card-header bg-primary text-white rounded-top">
