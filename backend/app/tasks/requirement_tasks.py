...
def send_requirement_report_email(report: dict, email: str):
    ...
    try:
        ...
        subject = f"🤖 AI-Powered Project Analysis: {project_name}"
...
def _generate_html_report(report: dict) -> str:
    ...
    <html>
        ...
        <body>
            <div class="container">
                <div class="header">
                    <h1>🤖 AI-Powered Requirements Analysis</h1>
                    <div class="subtitle">
                ...
                <div class="section">
                    ...
                    <div class="summary-grid">
                        ...
                        <div class="stat-box">
                            <div class="stat-number" style="color: #ffc107;">⏳ {summary.get('pending', 0)}</div>
                            <div class="stat-label">Pending</div>
                        </div>
                        <div class="stat-box">
                            <div class="stat-number" style="color: #2196F3;">🔄 {summary.get('in_progress', 0)}</div>
                            <div class="stat-label">In Progress</div>
                        </div>
                        <div class="stat-box">
                            <div class="stat-number" style="color: #28a745;">✅ {summary.get('completed', 0)}</div>
    ...
    if report.get("new_requirement"):
        html += f"""
                <div class="new-req">
                    <h3 style="margin-top: 0; color: #28a745;">🆕 New Requirement Added</h3>
    ...
    html += """
                <div class="section">
                    <h2>🎯 AI-Generated Execution Plan</h2>
    """
    ...
    if report.get("execution_plan_narrative"):
        html += f"""
                    <div class="ai-analysis" style="margin-top: 20px;">
                        <h4 style="margin-top: 0;">💭 AI Execution Insights</h4>
                        {report.get('execution_plan_narrative', '')}
                    </div>
        """
...
def send_roadmap_email(roadmap: dict, email: str):
    ...
    try:
        ...
        subject = f"📋 Project Roadmap: {project_name}"
